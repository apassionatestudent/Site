import { getStudentDocuments, getStudentDocumentDetail } from '../services/documentService.js';

// => GET /api/student-documents/my-documents
...
// => GET /api/student-documents/:publicId
