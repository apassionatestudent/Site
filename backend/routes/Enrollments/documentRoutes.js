// => public/routes/Enrollments/documentRoutes.js
// => Relocated from routes/documentRoutes.js into the Enrollments folder -
//    logic and route paths are unchanged, only import paths were adjusted
//    for the new folder depth. Still mounted at '/api/documents' in
//    server.js, a separate prefix from the enrollment routers above.

import express from 'express';
import { protectStudent } from '../../middleware/studentAuth.js';
import { proxyDocument } from '../../controllers/Enrollments/documentProxyController.js';
import { getMyDocuments, getMyDocumentDetail } from '../../controllers/Enrollments/documentController.js';
