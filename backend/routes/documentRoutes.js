...
router.get('/my-documents', readLimiter, protectStudent, getMyDocuments);
...
router.get('/detail/:publicId', readLimiter, protectStudent, getMyDocumentDetail);

// => GET /api/documents/:documentKey
// => readLimiter runs first to throttle abusive traffic before authorization
...
router.get('/:documentKey', readLimiter, protectStudent, proxyDocument);
